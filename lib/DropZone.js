...
class DropZone extends React.Component {
    ...
    reportMeasurements() {
      this.refs.wrapper.measure((_, __, width, height, x, y) => {
        this.context.dragContext.updateZone({width, height, x, y, ref: this.refs.wrapper, onEnter: this.onEnter, onLeave: this.onLeave, onDrop: this.onDrop});
      })
    }
    ...
    render() {
        return <View style={this.props.style} onLayout={this.reportMeasurements} ref="wrapper">
          {
