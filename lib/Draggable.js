...
class Draggable extends React.Component {
    ...
    _initiateDrag() {
      this.context.dragContext.onDrag(this.refs.wrapper, this.props.children, this.props.data);
    }
    ...
    render() {
        ...
        return <TouchableOpacity activeOpacity={this.props.activeOpacity} style={this.props.style} onLongPress={this.props.dragOn === 'onLongPress' ? this._initiateDrag : null}  onPressIn={this.props.dragOn === 'onPressIn' ? this._initiateDrag : null} ref="wrapper">
        {
